...
// // Precompute all standardd operations
...
//     add_op(Expr::Shl(standard_binop()));
//     add_op(Expr::Shr(standard_binop()));
...
//     add_op(Expr::Add(standard_binop()));
//     add_op(Expr::Sub(standard_binop()));
//     add_op(Expr::Mul(standard_binop()));
